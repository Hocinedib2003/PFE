...
<style>
    ...
    .stSpinner > div > div {
        border-top-color: #2b5876 !important;
    }
    .diagnostic-box {
    ...
    .current-diagnosis {
        font-weight: bold;
        border-left: 3px solid #2b5876 !important;
    }
...
def load_models():
    ...
    try:
        ...
        seg_model.load_state_dict(
            torch.load('C:/Users/Hocine/Desktop/PFE/coding/diagnostic/public/Models/aml_unet.pth', map_location='cpu'))
        seg_model.eval()
        ...
        vit_model.load_state_dict(
            torch.load('C:/Users/Hocine/Desktop/PFE/coding/diagnostic/public/Models/vit_cell_classifier.pth',
                       map_location='cpu'))
        vit_model.eval()
        models['classif_model'] = vit_model

        models['blood_model'] = joblib.load(
            'C:/Users/Hocine/Desktop/PFE/coding/diagnostic/public/Models/blood_cancer_classifier.pkl')
        models['label_encoder'] = joblib.load(
            'C:/Users/Hocine/Desktop/PFE/coding/diagnostic/public/Models/label_encoder.pkl')
